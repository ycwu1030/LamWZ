...
// Fri Apr 12 16:11:15 2019 by ROOT version 6.08/06
// from TTree Delphes/Analysis tree
// found on file: delphes_events_bbll_0401_15.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1398;
   const Int_t kMaxGenJet = 11;
   const Int_t kMaxGenMissingET = 1;
   const Int_t kMaxTrack = 232;
   const Int_t kMaxTower = 369;
   const Int_t kMaxEFlowTrack = 232;
   const Int_t kMaxEFlowPhoton = 167;
   const Int_t kMaxEFlowNeutralHadron = 53;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("delphes_events_bbll_0401_15.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("delphes_events_bbll_0401_15.root");
      }
